            ...
            <div id="highlight">
                ...
                <div class="description-images mb-4">
                    <div class="row d-flex justify-content-center align-items-center">
                        <div class="col"><img src="{{ asset('storage/ticket/' . $ticket->photo) }}" alt="" class="rounded" style="max-height: 300px"></div>
                    </div>
                </div>
                ...
                <div class="description mb-2 text-center">
                    ...
                    <h2 class="text-success">Rp. {{ number_format($ticket->price, 0, ',', '.') }}</h2>
                </div>
            </div>
        </div>
    </div>
